...
// Usando o reduce para tirar a media de notas dos filmes do array

// Ele não muda o array original e ele te retorna um valor - que valor? - o valor do acumulador

const moviesAVG = movies.reduce((acc, currentElement, index, sourceArray) => {
  if (index === sourceArray.length - 1) {
    console.log("Caiu no IF");
    acc += currentElement.vote_average;
  ...
  return (acc += currentElement.vote_average);
}, 0);

console.log(movies.length);

console.log(moviesAVG);
